...
export function CurrentSource({ pinA, pinB, startDrag, setPinA, setPinB, selected, onSelect, onDragStart, activePin, rotation }: Props) {
  ...
  return (
    <>
      ...
      <g transform={`rotate(${totalAngle}, ${midX}, ${midY})`} className={selected ? "selected" : undefined}>
        ...
        <line x1={midX - 6.5} y1={midY} x2={midX + 5.5} y2={midY} stroke="currentColor" strokeWidth={1.3} />
        <path d={`M ${midX + 5.5} ${midY} L ${midX + 1.5} ${midY - 3.5} L ${midX + 1.5} ${midY + 3.5} Z`} fill="currentColor" stroke="none" />
      </g>
